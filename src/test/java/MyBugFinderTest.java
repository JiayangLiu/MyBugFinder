...
public class MyBugFinderTest {
    ...
    public void detectBadStringComparisonTest() throws Exception {
        // test "=="
        String testPatternPath_1_1 = new File("").getAbsolutePath().concat("/src/test/java/testpatterns/testpattern1-1.txt");
        myBugFinder.setSourceCode(testPatternPath_1_1);
        assertFalse(myBugFinder.detectBadStringComparison());

        // test "!="
        String testPatternPath_1_2 = new File("").getAbsolutePath().concat("/src/test/java/testpatterns/testpattern1-2.txt");
        myBugFinder.setSourceCode(testPatternPath_1_2);
        assertFalse(myBugFinder.detectBadStringComparison());

        // test ".equlas"
        String testPatternPath_1_3 = new File("").getAbsolutePath().concat("/src/test/java/testpatterns/testpattern1-3.txt");
